...
// Constructor
public OrderDequeDemo(String customerId, String bookIsbn, int quantity, int total) {
...
private class Node {
    ...
    public Node(OrderDequeDemo data) {
        this.data = data;
        this.prev = null;
        this.next = null;
    }
...
// Tambah di depan
public void addFront(OrderDequeDemo data) {
...
// Tambah di belakang
public void addRear(OrderDequeDemo data) {
    Node newNode = new Node(data);
    if (isEmpty()) {
        head = tail = newNode;
    } else {
...
// Lihat depan
public OrderDequeDemo peekFront() {
    return isEmpty() ? null : head.data;
}

// Lihat belakang
public OrderDequeDemo peekRear() {
...
public static void main(String[] args){
    ...
    // Tambah data
    deque.addRear(new OrderDequeDemo("C001", "978-1", 2, 170000));
    deque.addRear(new OrderDequeDemo("C002", "978-2", 1, 95000));
    deque.addFront(new OrderDequeDemo("C003", "978-3", 5, 395000));
